...
export default class Button {
  constructor(scene, x, y, width, height, label, actionData, { buttonBorderColor=0x696969, 
    ...
    g.fillRoundedRect(rect.x, rect.y, rect.width, rect.height, 8)
                        .setInteractive(rect, isWithin).setData('action', actionData);
    ...
    this.goText = text; //game object text
    this.goGraphics = g;
  }

  hide() {
    this.goText.setVisible(false);
    this.goGraphics.setVisible(false);
  }
}
